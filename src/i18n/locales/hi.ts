...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor चालू है, इसलिए मिंट अनुरोध रुके हुए हैं: वे खुले नेट पर जाते और आपके IP को आपके ecash से जोड़ देते। मेश पर भेजना और लेना अब भी चलता है। सेटिंग्स, सुरक्षा के नीचे मिंट ट्रैफ़िक की अनुमति दें।",
  ...
  "wallet.send.bearer_note":
    "यह स्ट्रिंग जिसके पास है, पैसा उसी का है। सिक्के सुरक्षित रखे हैं, खर्च नहीं हुए: अगर यह किसी तक न पहुँचे तो आप उन्हें लंबित के नीचे वापस ले सकते हैं।",
  ...
  "wallet.send.sent_to_body":
    "{route} जब तक आप पुष्टि न करें कि उन्हें मिल गया, या जब तक मिंट न बताए कि टोकन भुनाया जा चुका, तब तक यह लंबित के नीचे वापस लिया जा सकता है।",
  ...
  "wallet.pay.confirm_reclaimable":
    "जब तक वे इसे क्लेम नहीं करते, आप इसे लंबित से वापस ले सकते हैं।",
  ...
  "wallet.svc.tor_ios_body":
    "Arti सिर्फ़ Nostr WebSocket को लपेटता है, इसलिए यह अनुरोध खुले नेट से मिंट तक पहुँचता और आपके IP को इस ecash से जोड़ देता। सेटिंग्स > सुरक्षा के नीचे इसकी अनुमति दें, या पहले Tor बंद करें। मेश पर ecash भेजना और लेना अब भी चलता है।",
  ...
  "wallet.svc.lock_in_doubt_body":
    "और कुछ नहीं भेजा गया। जब तक मिंट नतीजे की पुष्टि न करे, सिक्के रोके गए हैं। अगर भुगतान हुआ, तो लॉक टोकन सौंपने के लिए लंबित में दिखेगा। नहीं हुआ, तो सिक्के वापस आ जाएँगे।",
