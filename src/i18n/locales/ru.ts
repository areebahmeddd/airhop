...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor включён, поэтому запросы к монетному двору заблокированы: они пошли бы по открытой сети и связали ваш IP с вашим ecash. Отправка и приём через сеть по-прежнему работают. Разрешите трафик к монетному двору в разделе «Настройки», «Безопасность».",
  ...
  "wallet.send.bearer_note":
    "Деньги принадлежат тому, у кого эта строка. Монеты зарезервированы, а не потрачены: если строка никого не достигнет, их можно вернуть в разделе «Ожидающие».",
  ...
  "wallet.send.sent_to_body":
    "{route} Токен остаётся возвратным в разделе «Ожидающие», пока вы не подтвердите получение или пока монетный двор не сообщит, что токен погашен.",
  ...
  "wallet.svc.tor_ios_body":
    "Arti оборачивает только веб-сокеты Nostr, поэтому этот запрос дошёл бы до монетного двора по открытой сети и связал ваш IP с этим ecash. Разрешите это в разделе «Настройки» > «Безопасность» или сначала выключите Tor. Отправка и приём ecash по сети по-прежнему работают.",
  ...
  "wallet.svc.lock_in_doubt_body":
    "Больше ничего не отправлено. Монеты удерживаются, пока монетный двор не подтвердит результат. Если платёж прошёл, заблокированный токен появится в разделе «Ожидающие», чтобы вы его передали. Если нет, монеты вернутся.",
