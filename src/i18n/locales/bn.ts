...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor চালু, তাই মিন্টের অনুরোধ আটকে আছে: সেগুলো খোলা নেটে বেরিয়ে আপনার IP-কে আপনার ecash-এর সঙ্গে জুড়ে দিত। মেশে পাঠানো ও নেওয়া তবুও চলে। সেটিংসের নিরাপত্তায় মিন্টের যাতায়াতের অনুমতি দিন।",
  ...
  "wallet.send.bearer_note":
    "যে এই লেখাটি ধরে রাখে টাকাটা তারই। মুদ্রাগুলো সরিয়ে রাখা, খরচ হয়ে যায়নি: এটি যদি কারও কাছেই না পৌঁছায় তবে অপেক্ষমাণ থেকে ফিরিয়ে নিতে পারবেন।",
  ...
  "wallet.send.sent_to_body":
    "{route} তারা পেয়েছে বলে আপনি নিশ্চিত না করা পর্যন্ত, বা মিন্ট টোকেনটি ভাঙানো হয়েছে বলে না জানানো পর্যন্ত, এটি অপেক্ষমাণে ফিরিয়ে নেওয়ার মতোই থাকে।",
  ...
  "wallet.svc.tor_ios_body":
    "Arti কেবল Nostr-এর WebSocket মুড়ে রাখে, তাই এই অনুরোধটি খোলা নেটে মিন্টে পৌঁছে আপনার IP-কে এই ecash-এর সঙ্গে জুড়ে দিত। সেটিংস > নিরাপত্তায় এটি অনুমোদন করুন, বা আগে Tor বন্ধ করুন। মেশে ecash পাঠানো ও নেওয়া তবুও চলে।",
  ...
  "wallet.svc.lock_in_doubt_body":
    "আর কিছু পাঠানো হয়নি। মিন্ট ফলাফল নিশ্চিত না করা পর্যন্ত মুদ্রাগুলো আটকে রাখা হয়েছে। যদি গিয়ে থাকে, লক করা টোকেনটি হস্তান্তরের জন্য অপেক্ষমাণে দেখাবে। না গেলে মুদ্রাগুলো ফিরে আসবে।",
