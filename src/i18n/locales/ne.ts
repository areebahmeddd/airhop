...
export const strings: Strings = {
  ...
  "onboarding.welcome.transfer": "अर्को फोनबाट ल्याउनुहोस्",
  ...
  "onboarding.transfer.title": "अर्को फोनबाट ल्याउनुहोस्",
  "onboarding.transfer.preparing": "तयार हुँदैछ",
  "onboarding.transfer.scan_heading":
    "यो कोड आफ्नो पुरानो फोनले स्क्यान गर्नुहोस्",
  "onboarding.transfer.step_open": "आफ्नो पुरानो फोनमा Airhop खोल्नुहोस्",
  "onboarding.transfer.step_go": "{tab} मा जानुहोस्, त्यसपछि {row}",
  "onboarding.transfer.step_scan": "त्यसलाई यो कोडतिर तेर्स्याउनुहोस्",
  "onboarding.transfer.network_note":
    "दुवै फोन एउटै Wi-Fi वा हटस्पटमा हुनुपर्छ। केही पनि इन्टरनेटबाट जाँदैन।",
  "onboarding.transfer.qr_a11y":
    "सार्ने कोड। आफ्नो पुरानो फोनको Airhop ले यसलाई स्क्यान गर्नुहोस्।",
  "onboarding.transfer.offline_title": "Wi-Fi मा जोडिनुहोस्",
  ...
  "onboarding.transfer.failed_interrupted":
    "जडान टुट्यो। यहाँ केही पनि सुरक्षित भएन।",
  "onboarding.transfer.failed_storage":
    "आएको कुरा यो फोनले सुरक्षित गर्न सकेन, त्यसैले केही पनि राखिएन।",
  "onboarding.transfer.failed_incompatible":
    "तपाईंको पुरानो फोनमा Airhop को नयाँ संस्करण छ। यो फोन अद्यावधिक गर्नुहोस्, अनि फेरि प्रयास गर्नुहोस्।",
  "onboarding.transfer.failed_unavailable":
    "यो फोनले स्थानीय नेटवर्क जडान खोल्न सक्दैन।",
  ...
  "chat.group.leave_creator_body":
    "{name} छाड्ने? तपाईंले यो समूह बनाउनुभएको हो, र बनाउनेले मात्र सदस्य थप्न वा हटाउन सक्छ, त्यसैले तपाईंले छाडेपछि कसैले पनि सक्ने छैन। यसको इतिहास यो यन्त्रबाट हट्नेछ।",
  "chat.group.e2ee":
    "छेउदेखि छेउसम्म गुप्तीकृत। सन्देश सदस्यले मात्र पढ्न सक्छन्।",
  "chat.group.cap":
  ...
  "chat.ecash.already_claimed_body":
    "यो टोकनमा भएको सबै पहिल्यै तपाईंको वालेटमा छ, त्यसैले केही थपिएन।",
  ...
  "wallet.balance.locked":
    "वालेटको भण्डारण बन्द छ। तपाईंको ecash एउटा गुप्तीकृत फाइलमा राखिन्छ जसको कुञ्जी यन्त्रको कुञ्जी सङ्ग्रहमा बस्छ, र त्यो फाइल खुलेन। आफ्नो यन्त्र खोलेर Airhop फेरि खोल्नुहोस्।",
  "wallet.balance.tor_blocked":
    "Tor खुला छ, त्यसैले टकसारका अनुरोध रोकिएका छन्: ती खुला सञ्जालबाट जान्थे र तपाईंको IP तपाईंको ecash सँग जोड्थे। मेशबाट पठाउने र लिने काम भने चलिरहन्छ। तैपनि टकसारसम्म पुग्न सेटिङमा {setting} खोल्नुहोस्।",
  "wallet.balance.offline":
    "अफलाइन। तपाईं अझै नजिकका मानिसलाई भुक्तानी गर्न र टोकन पठाउन सक्नुहुन्छ।",
  "wallet.balance.internet_off":
    "इन्टरनेट बन्द छ, त्यसैले वालेट नजिकमा मात्र चल्छ। टकसारसम्म पुग्न सेटिङमा {setting} खोल्नुहोस्।",
  ...
  "wallet.action.scan": "स्क्यान",
  "wallet.action.scan_a11y": "टोकन, बिल वा npub स्क्यान गर्नुहोस्",
  "wallet.choose.paste": "टोकन टाँस्नुहोस्",
  "wallet.choose.paste_desc": "अफलाइनमा पनि चल्छ",
  "wallet.choose.scan": "QR कोड स्क्यान गर्नुहोस्",
  "wallet.choose.scan_desc": "कुनै पनि वालेटको Cashu टोकन",
  "wallet.choose.topup": "Lightning बाट टप अप",
  "wallet.choose.topup_desc": "कुनै पनि Lightning वालेटबाट बिल तिर्नुहोस्",
  "wallet.choose.token": "टोकन बनाउनुहोस्",
  "wallet.choose.token_desc":
    "साझा गर्नुहोस् वा QR कोड देखाउनुहोस्, अफलाइनमा पनि",
  "wallet.choose.zap": "Nostr सम्पर्कलाई zap पठाउनुहोस्",
  "wallet.choose.zap_desc": "उनको npub मा, इन्टरनेटबाट",
  "wallet.choose.invoice": "Lightning बिल तिर्नुहोस्",
  "wallet.choose.invoice_desc": "कुनै पनि Lightning वालेटमा निकाल्नुहोस्",
  "wallet.choose.tor_paused": "Tor खुला रहुन्जेल रोकिएको",
  "wallet.choose.offline": "इन्टरनेट चाहिन्छ",
  "wallet.choose.internet_off": "इन्टरनेट बन्द छ",
  "wallet.choose.needs_mint": "पहिले टकसार थप्नुहोस्",
  ...
  "wallet.send.bearer_note":
    "यो सूत्र जससँग हुन्छ, पैसा उसैको हो। सिक्का छुट्याइएका छन्, खर्च भएका होइनन्: यो कसैसम्म पुगेन भने तपाईं ती गतिविधि अन्तर्गत फिर्ता लिन सक्नुहुन्छ।",
  ...
  "wallet.send.inexact_body":
    "तपाईंका सिक्काले अफलाइन ठ्याक्कै {amount} {unit} बनाउन सक्दैनन्। तपाईंले बनाउन सक्ने सबैभन्दा सानो टोकन {spend} {unit} हो, र अफलाइनमा फिर्ता हुँदैन: थप {extra} {unit} पाउनेलाई नै जान्छ।\n\nअनलाइन हुँदा टकसारमा ताजा गरे तपाईंका सिक्का ठ्याक्कै मिल्ने अङ्कमा बाँडिन्थे।",
  "wallet.send.send_amount": "{amount} पठाउनुहोस्",
  "wallet.send.sent_to": "{name} लाई {amount} {unit} पठाइयो",
  "wallet.send.sent_to_body":
    "{route} उनीहरूले पाए भनेर तपाईंले पक्का नगरेसम्म, वा टकसारले टोकन साटियो भनेर हामीलाई नभनेसम्म यो गतिविधि अन्तर्गत फिर्ता लिन मिल्छ।",
  ...
  "wallet.mint.none_desc":
    "टकसारले तपाईंको ecash जारी गर्छ र साट्छ। Lightning बाट टप अप गर्न वा यसका टोकन लिन एउटा थप्नुहोस्।",
  ...
  "wallet.ln.withdrawn":
    "Lightning बाट {amount} {unit} तिरियो। टकसारले {fee} {unit} बाटो शुल्क लियो।",
  "wallet.ln.withdrawn_with_change":
    "Lightning बाट {amount} {unit} तिरियो। टकसारले {fee} {unit} बाटो शुल्क लियो, र सञ्चितिको {change} {unit} तपाईंको ब्यालेन्समा फर्कायो।",
  ...
  "wallet.reclaim.body":
    "{amount} {unit} तपाईंको ब्यालेन्समा फर्कन्छ, र टकसारसम्म पुग्न सकिनेबित्तिकै तपाईंले दिएको टोकन चल्न छाड्छ। त्यसअघि नै उनीहरूले साटे भने, पैसा उनीहरूकै रहन्छ।",
  "wallet.reclaim.keep": "बाँकी नै राख्नुहोस्",
  "wallet.reclaim.confirm": "फिर्ता लिनुहोस्",
  "wallet.reclaim.claimed_title": "उनीहरूले पहिल्यै साटिसके",
  ...
  "wallet.pending.reserved_desc":
    "बनेको र छुट्याइएको, पुगेको पुष्टि छैन। दुई पटक खर्च नहोस् भनेर सिक्का तपाईंको ब्यालेन्सबाहिर राखिन्छन्।",
  ...
  "wallet.mesh_offline_body":
    "मेश सेवा चलिरहेको छैन, त्यसैले टोकन दिने कोही छैन। यो गतिविधि अन्तर्गत छुट्याइएकै रहन्छ।",
  ...
  "wallet.xfer.inexact_body":
    "तपाईंका सिक्काले अफलाइन ठ्याक्कै {amount} {unit} बनाउन सक्दैनन्। तपाईंले बनाउन सक्ने सबैभन्दा सानो टोकन {spend} {unit} हो, र थप {extra} {unit} फिर्ता ल्याउने उपायबिनै उनीहरूकहाँ जान्छ।\n\nअनलाइन हुँदा टकसारमा ताजा गरे तपाईंका सिक्का ठ्याक्कै मिल्ने अङ्कमा बाँडिन्छन्।",
  ...
  "wallet.pay.rail_nutzap_undelivered":
    "उनीहरूकै कुञ्जीमा बाँधिएको, तर अझै कसैले बोक्न सकेको छैन। यो लाइनमा छ, र टोकन गतिविधि अन्तर्गत छ।",
  "wallet.pay.final":
  ...
  "wallet.scan.title_any": "QR कोड स्क्यान गर्नुहोस्",
  "wallet.scan.aim_any": "टोकन, बिल वा npub को QR कोडमा तेर्स्याउनुहोस्।",
  "wallet.scan.no_any": "त्यो तस्बिरमा टोकन, बिल वा npub भेटिएन।",
  ...
  "wallet.svc.tor_ios_body":
    "iOS मा Tor ले Nostr मात्र ढाक्छ, त्यसैले यो अनुरोध टकसारसम्म खुला सञ्जालबाट पुग्थ्यो र तपाईंको IP यो ecash सँग जोड्थ्यो। सेटिङमा {setting} खोल्नुहोस्, वा पहिले Tor बन्द गर्नुहोस्। मेशबाट ecash पठाउने र लिने काम भने चलिरहन्छ।",
  "wallet.svc.internet_off": "इन्टरनेट बन्द छ, त्यसैले टकसारमा पुग्न सकिँदैन।",
  "wallet.svc.internet_off_body":
    "सेटिङमा {setting} खोल्नुहोस्। नजिकमा ecash पठाउने र लिने काम अझै चल्छ।",
  ...
  "wallet.svc.storage_locked_body":
    "Airhop ले तपाईंको ecash एउटा गुप्तीकृत फाइलमा राख्छ जसको कुञ्जी यन्त्रको कुञ्जी सङ्ग्रहमा बस्छ। यन्त्र खोलेर एप फेरि खोल्नुहोस्।",
  ...
  "wallet.svc.refuse_http_body":
    "सञ्जालको बाटोमा भएको जोसुकैले तपाईंको ecash पढ्न वा बदल्न सक्थ्यो। https:// भएको टकसार चलाउनुहोस्।",
  ...
  "wallet.svc.inexact_title":
    "तपाईंका सिक्काले अफलाइन ठ्याक्कै {amount} {unit} बनाउन सक्दैनन्।",
  ...
  "settings.share_app": "Airhop एप साझा गर्नुहोस्",
  "settings.share_app_short": "एप साझा गर्नुहोस्",
  "settings.share_app_dialog": "Airhop लिनुहोस्",
  "settings.share_app_unsupported": "यो इन्स्टल साझा गर्न सकिँदैन",
  "settings.share_app_unsupported_body":
    "यो Airhop इन्स्टल धेरै भागमा राखिएको छ र एउटै फाइलको रूपमा साझा गर्न सकिँदैन। बरु GitHub Releases बाट एकल फाइल संस्करण डाउनलोड गर्नुहोस्।",
  ...
  "settings.conn.autostart": "स्वतः सुरु गर्नुहोस्",
  "settings.conn.autostart_desc":
    "तपाईंको फोन रिस्टार्ट भएपछि मेशलाई फेरि सुरु गर्छ",
  "settings.conn.autostart_on_title": "रिस्टार्ट पछि Airhop सुरु गर्ने?",
  "settings.conn.autostart_on_body":
    "तपाईंको फोन अर्को पटक रिस्टार्ट हुँदा Airhop आफैं सुरु भई मेशमा फेरि जोडिन्छ, र त्यसो नभएसम्म कुनै सूचना देखिँदैन। केही फोन निर्माताहरूले तपाईंले आफ्नै ब्याट्री सेटिङमा पनि अनुमति नदिएसम्म यसलाई रोक्छन्।",
  "settings.conn.autostart_off_title": "रिस्टार्ट पछि सुरु हुन बन्द गर्ने?",
  "settings.conn.autostart_off_body":
    "तपाईंले आफैं नखोलेसम्म Airhop तपाईंको फोन रिस्टार्ट भएपछि बन्द नै रहन्छ।",
  ...
  "settings.storage.storage_usage_desc":
    "सन्देश, ecash, र क्यासमा रहेका संलग्नक",
  ...
  "settings.transfer.chats_without": "तपाईंका कोठा र समूह, तिनका सन्देशबिना",
  "settings.transfer.wallet": "वालेटको ब्यालेन्स",
  "settings.transfer.wallet_desc": "ecash र कारोबारको इतिहास",
  ...
  "settings.transfer.auth_prompt":
    "आफ्नो पहिचान सार्न यो तपाईं नै हो भनी पुष्टि गर्नुहोस्",
  "settings.transfer.scan_title": "नयाँ फोनमा देखिएको कोड स्क्यान गर्नुहोस्",
  "settings.transfer.aim": "क्यामेरा नयाँ फोनमा देखिएको कोडतिर तेर्स्याउनुहोस्",
  "settings.transfer.wrong_code":
    "यो सम्पर्कको कोड हो। नयाँ फोनमा देखिएको कोड स्क्यान गर्नुहोस्।",
  ...
  "settings.transfer.sending": "सार्दै {percent}%",
  "settings.transfer.keep_open": "यो नसकिएसम्म दुवै फोन खुला राख्नुहोस्।",
  "settings.transfer.finishing": "तपाईंको नयाँ फोनमा सक्दै",
  "settings.transfer.erasing": "यो फोन मेटाउँदै",
  "settings.transfer.done_title": "सारियो",
  "settings.transfer.done_body":
    "तपाईंको पहिचान अब नयाँ फोनमा छ, र यो फोन मेटाइएको छ।",
  "settings.transfer.failed_title": "सार्ने काम पूरा भएन",
  "settings.transfer.failed_unreachable":
    "तपाईंको नयाँ फोनसम्म पुग्न सकिएन। दुवै फोनलाई एउटै Wi-Fi मा जोड्नुहोस्, वा एउटामा हटस्पट खोलेर अर्कोबाट त्यसमा जोडिनुहोस्।",
  "settings.transfer.failed_permission":
    "तपाईंको नयाँ फोनसम्म पुग्न Airhop लाई स्थानीय नेटवर्क पहुँच चाहिन्छ। सेटिङमा अनुमति दिनुहोस्, अनि फेरि प्रयास गर्नुहोस्।",
  "settings.transfer.failed_wrong_phone":
    "जवाफ दिने फोन तपाईंले कोड स्क्यान गरेको फोन होइन।",
  "settings.transfer.failed_incompatible":
    "तपाईंको नयाँ फोनमा Airhop को पुरानो संस्करण छ। त्यसलाई अद्यावधिक गर्नुहोस्, अनि फेरि प्रयास गर्नुहोस्।",
  "settings.transfer.failed_cancelled":
    "तपाईंको नयाँ फोनमा सार्ने काम रद्द गरियो।",
  "settings.transfer.failed_storage":
    "तपाईंको नयाँ फोनले सबथोक सुरक्षित गर्न सकेन।",
  "settings.transfer.failed_interrupted": "सबथोक पठाउनुअघि नै जडान टुट्यो।",
  "settings.transfer.unchanged": "केही पनि सरेन, र यो फोन पहिलेजस्तै चल्छ।",
  "settings.transfer.unconfirmed_title": "सार्ने काम पूरा भयो?",
  "settings.transfer.unconfirmed_body":
    "पुष्टि हुनुअघि नै यो फोनको तपाईंको नयाँ फोनसँग सम्पर्क टुट्यो। नयाँ फोनले तपाईंको नाम देखाउँछ भने यो फोन मेटाउनुहोस्। नत्र यही फोन चलाइरहनुहोस् र फेरि प्रयास गर्नुहोस्।",
  "settings.transfer.erase_cta": "यो फोन मेटाउनुहोस्",
  "settings.transfer.keep_cta": "यही फोन चलाइरहनुहोस्",
...
export const plurals: Plurals = {
  ...
  "wallet.backup.recovered": {
    one: "{mints} बाट {count} नखर्चिएको सिक्का फिर्ता आयो।",
