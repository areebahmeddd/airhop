...
export const strings: Strings = {
  ...
  "chat.filter.a11y": "筛选聊天",
  "chat.filter.all": "全部",
  "chat.filter.unread": "未读",
  "chat.filter.verified": "已验证",
  "chat.filter.nearby": "附近",
  "chat.filter.private": "私密",
  "chat.filter.none": "没有符合此筛选条件的聊天",
  ...
  "onboarding.hello.p1":
    "Airhop 是基于 bitchat 构建的一个独立开源业余项目。它与 bitchat 项目没有从属关系，也未获其背书，也不是对任何现有应用或服务的仿冒，只是我乐于打造并分享给社区的东西。",
  "onboarding.hello.p2":
  ...
  "chat.cmd.emote_needs_target": "请指定对象，例如 /{command} @名字",
  ...
  "chat.attach.empty_file": "该文件是空的，没有可发送的内容。",
  ...
  "wallet.balance.tor_blocked":
    "Tor 已开启，因此铸币厂请求被拦截：它们会走明网发出，把你的 IP 和你的 ecash 关联起来。通过网状网络收发仍然可用。可在设置的安全里允许铸币厂流量。",
  ...
  "wallet.send.bearer_note":
    "谁拿着这串字符，钱就是谁的。这些币是被预留而不是已花掉：如果它始终没有送到任何人手上，你可以在待处理里收回。",
  ...
  "wallet.send.sent_to_body":
    "{route} 在你确认对方收到之前，或者在铸币厂告知代币已被兑付之前，它都留在待处理里可以收回。",
  ...
  "wallet.svc.tor_ios_body":
    "Arti 只包裹 Nostr 的 WebSocket，所以这个请求会走明网到达铸币厂，把你的 IP 和这笔 ecash 关联起来。可以在设置 > 安全里允许它，或者先关掉 Tor。通过网状网络收发 ecash 仍然可用。",
  ...
  "wallet.svc.lock_in_doubt_body":
    "没有发送其他任何东西。在铸币厂确认结果之前，这些币会被保留。若付款已完成，锁定的代币会出现在“待处理”中供你转交。若未完成，币会退回。",
  ...
  "settings.network.wifi_aware_desc":
    "同一平台的两部手机之间更快地传输照片和文件。蓝牙无论如何都会传送一切。",
  "settings.network.wifi_unstable":
    "已暂停。它一直干扰这部手机的 Wi-Fi。关闭再打开可重试。",
