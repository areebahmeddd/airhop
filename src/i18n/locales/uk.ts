...
export const strings: Strings = {
  ...
  "chat.filter.a11y": "Фільтр чатів",
  "chat.filter.all": "Усі",
  "chat.filter.unread": "Непрочитані",
  "chat.filter.verified": "Підтверджено",
  "chat.filter.nearby": "Поблизу",
  "chat.filter.private": "Приватні",
  "chat.filter.none": "Жоден чат не відповідає цьому фільтру",
  ...
  "wallet.balance.tor_blocked":
    "Tor увімкнено, тож запити до мінта заблоковано: вони пішли б відкритою мережею і пов’язали б вашу IP-адресу з вашим ecash. Надсилання й отримання через mesh працює далі. Дозвольте трафік мінта в Налаштуваннях, Безпека.",
  ...
  "wallet.send.bearer_note":
    "Хто тримає цей рядок, той володіє грошима. Монети відкладено, а не витрачено: якщо він нікого не досягне, ви зможете забрати їх у розділі Очікують.",
  ...
  "wallet.send.sent_to_body":
    "{route} Забрати назад можна в розділі Очікують, доки ви не підтвердите, що вони це отримали, або доки мінт не скаже нам, що токен викуплено.",
  ...
  "wallet.svc.tor_ios_body":
    "Arti загортає лише вебсокети Nostr, тож цей запит дістався б мінта відкритою мережею і пов’язав би вашу IP-адресу з цим ecash. Дозвольте це в Налаштуваннях > Безпека або спершу вимкніть Tor. Надсилання й отримання ecash через mesh працює далі.",
  ...
  "wallet.svc.lock_in_doubt_body":
    "Більше нічого не надіслано. Монети утримуються, доки мінт не підтвердить результат. Якщо платіж пройшов, заблокований токен з’явиться в розділі «Очікують», щоб ви його передали. Якщо ні, монети повернуться.",
  ...
  "settings.network.wifi_aware_desc":
    "Швидша передача фото та файлів між двома телефонами однієї платформи. Bluetooth у будь-якому разі переносить усе.",
  "settings.network.wifi_unstable":
    "Призупинено. Воно постійно порушувало Wi-Fi на цьому телефоні. Вимкніть і ввімкніть, щоб спробувати ще раз.",
  ...
  "settings.conn.autostart_off_body":
    "Airhop залишатиметься закритим після перезавантаження телефону, доки ви не відкриєте його самі.",
...
export const plurals: Plurals = {
  ...
  "wallet.mint.remove_body": {
    ...
    other:
      "{mint} тримає {balance} {unit} в {count} монеті. Видалення назавжди стирає цю монету з цього пристрою, і резервної копії немає. Спершу виведіть або надішліть баланс.",
  },
  ...
  "wallet.spent_removed_detail": {
    ...
    other: "{count} монети вже було витрачено, і її вилучено.",
  },
