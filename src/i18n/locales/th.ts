...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor เปิดอยู่ คำขอไปยังมินต์จึงถูกบล็อก เพราะจะออกไปทางเครือข่ายเปิดและเชื่อม IP ของคุณเข้ากับ ecash ของคุณ การส่งและรับผ่านเมชยังทำงานอยู่ อนุญาตการรับส่งข้อมูลกับมินต์ได้ในการตั้งค่า ความปลอดภัย",
  ...
  "wallet.send.bearer_note":
    "ใครก็ตามที่ถือสตริงนี้คือเจ้าของเงิน เหรียญถูกกันไว้ ไม่ใช่ถูกใช้ไป หากมันไม่ไปถึงใครเลย คุณเรียกคืนได้ในหัวข้อรอดำเนินการ",
  ...
  "wallet.send.sent_to_body":
    "{route} มันยังเรียกคืนได้ในหัวข้อรอดำเนินการจนกว่าคุณจะยืนยันว่าพวกเขาได้รับ หรือจนกว่ามินต์จะแจ้งว่าโทเคนถูกแลกไปแล้ว",
  ...
  "wallet.svc.tor_ios_body":
    "Arti ห่อหุ้มเฉพาะ WebSocket ของ Nostr คำขอนี้จึงจะไปถึงมินต์ผ่านเครือข่ายเปิดและเชื่อม IP ของคุณเข้ากับ ecash นี้ อนุญาตได้ที่การตั้งค่า > ความปลอดภัย หรือปิด Tor ก่อน การส่งและรับ ecash ผ่านเมชยังทำงานอยู่",
  ...
  "wallet.svc.lock_in_doubt_body":
    "ไม่มีการส่งอย่างอื่นเพิ่ม เหรียญถูกกันไว้จนกว่ามินต์จะยืนยันผลลัพธ์ หากสำเร็จ โทเคนที่ล็อกไว้จะแสดงในรายการรอดำเนินการเพื่อให้คุณส่งต่อ หากไม่สำเร็จ เหรียญจะกลับมา",
