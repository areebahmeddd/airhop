...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor ჩართულია, ამიტომ ზარაფხანასთან მოთხოვნები დაბლოკილია: ისინი ღია ქსელით გავიდოდა და შენს IP-ს შენს ecash-თან დააკავშირებდა. მეშით გაგზავნა და მიღება მაინც მუშაობს. დაუშვი ზარაფხანის ტრაფიკი პარამეტრებში, უსაფრთხოებაში.",
  ...
  "wallet.send.bearer_note":
    "ვისაც ეს სტრიქონი უჭირავს, ფული მისია. მონეტები დარეზერვებულია და არა დახარჯული: თუ ის ვერავის მიაღწევს, შეგიძლია დაიბრუნო „მოლოდინში“-დან.",
  ...
  "wallet.send.sent_to_body":
    "{route} ის „მოლოდინში“ დაბრუნებადი რჩება, სანამ არ დაადასტურებ, რომ მიიღო, ან სანამ ზარაფხანა არ გვეტყვის, რომ ტოკენი გამოსყიდულია.",
  ...
  "wallet.svc.tor_ios_body":
    "Arti მხოლოდ Nostr-ის WebSocket-ებს ფარავს, ამიტომ ეს მოთხოვნა ზარაფხანას ღია ქსელით მიაღწევდა და შენს IP-ს ამ ecash-თან დააკავშირებდა. დაუშვი პარამეტრები > უსაფრთხოება-ში, ან ჯერ გამორთე Tor. მეშით ecash-ის გაგზავნა და მიღება მაინც მუშაობს.",
  ...
  "wallet.svc.lock_in_doubt_body":
    "სხვა არაფერი გაგზავნილა. მონეტები დაკავებულია, სანამ ზარაფხანა შედეგს დაადასტურებს. თუ გადახდა შესრულდა, ჩაკეტილი ტოკენი გამოჩნდება მოლოდინში გადასაცემად. თუ არა, მონეტები დაბრუნდება.",
