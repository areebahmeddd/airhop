...
export const strings: Strings = {
  ...
  "onboarding.transfer.confirm_title": "သင့်ဖုန်းအဟောင်းကို စစ်ဆေးပါ",
  "onboarding.transfer.confirm_body":
    "သင့်ဖုန်းအဟောင်းတွင်လည်း ဤစကားလုံးများအတိုင်း ပြနေရမည်။ မတူသော စကားလုံးများ ပြနေလျှင် သို့မဟုတ် ဘာမျှ မပြလျှင် ပယ်ဖျက်ပါ။",
  "onboarding.transfer.confirm_cta": "ကိုက်ညီသည်",
  ...
  "launch.keys_unreadable_title": "သင့်သော့များကို ဖွင့်၍ မရပါ",
  "launch.keys_unreadable_body":
    "သင့်ဖုန်းက Airhop ၏ သော့များကို မဖွင့်ပေးခဲ့ပါ။ ဖုန်းကို သော့ဖွင့်ပြီး ထပ်စမ်းကြည့်ပါ။",
  "launch.start_over": "ဖျက်ပြီး အစမှ ပြန်စပါ",
  "launch.start_over_confirm_title": "ဤဖုန်းကို ဖျက်မလား?",
  "launch.start_over_confirm_body":
    "ဤဖုန်းပေါ်ရှိ သင့်အထောက်အထား၊ မက်ဆေ့ဂျ်၊ အဆက်အသွယ်နှင့် ပိုက်ဆံအိတ်တို့ကို ဖျက်ဆီးမည်ဖြစ်ပြီး သင်သည် လူသစ်တစ်ယောက်အဖြစ် အစမှ ပြန်စရမည်။ ဤအရာကို ပြန်ပြင်၍ မရပါ။",
  ...
  "chat.group.leave_creator_body":
    "{name} မှ ထွက်မလား? ဤအဖွဲ့ကို သင်ဖန်တီးခဲ့ပြီး အဖွဲ့ဝင်များကို ထည့်ခြင်း၊ ဖယ်ရှားခြင်းကို ဖန်တီးသူသာ လုပ်နိုင်သောကြောင့် သင်ထွက်ပြီးနောက် မည်သူမျှ လုပ်နိုင်တော့မည် မဟုတ်ပါ။ မှတ်တမ်းကိုလည်း ဤစက်မှ ဖယ်ရှားပါမည်။",
  "chat.group.e2ee":
    "အစမှအဆုံး စာဝှက်ထားသည်။ မက်ဆေ့ဂျ်များကို အဖွဲ့ဝင်များသာ ဖတ်နိုင်သည်။",
  "chat.group.cap":
  ...
  "chat.media.gone_note": "ဤစက်ပေါ်တွင် မသိမ်းထားတော့ပါ",
  ...
  "chat.ecash.locked": "အခြားသူထံ သော့ခတ်ထားသည်",
  ...
  "chat.ecash.already_claimed_body":
    "ဤတိုကင်ရှိ အရာအားလုံးသည် သင့်ပိုက်ဆံအိတ်တွင် ရှိပြီးဖြစ်၍ ဘာမျှ ထပ်မထည့်ပါ။",
  ...
  "mesh.banner.hint.tor_settings": "Airhop ၏ Tor ဆက်တင်များကို ဖွင့်သည်",
  ...
  "mesh.radar.peer_in_range": "{name}၊ အကွာအဝေးအတွင်း",
  "mesh.radar.peer_recent": "{name}၊ မကြာမီက တွေ့ခဲ့သည်",
  "mesh.radar.relay_in_range": "{name}၊ ထပ်ဆင့်လွှင့်ဆုံမှတ်၊ အကွာအဝေးအတွင်း",
  "mesh.radar.relay_recent": "{name}၊ ထပ်ဆင့်လွှင့်ဆုံမှတ်၊ မကြာမီက တွေ့ခဲ့သည်",
  ...
  "wallet.balance.locked":
    "ပိုက်ဆံအိတ်သိုလှောင်မှု သော့ခတ်ထားသည်။ သင့် ecash ကို စက်၏သော့သိမ်းတွင် သော့ရှိသည့် စာဝှက်ဖိုင်တစ်ခုအတွင်း သိမ်းထားပြီး ထိုဖိုင်ကို မဖွင့်နိုင်ခဲ့ပါ။ သင့်စက်၏သော့ကို ဖွင့်ပြီး Airhop ကို ပြန်ဖွင့်ပါ။",
  "wallet.balance.tor_blocked":
    "Tor ဖွင့်ထားသဖြင့် မင့်တောင်းဆိုမှုများကို ပိတ်ဆို့ထားသည်၊ ၎င်းတို့သည် ပွင့်လင်းကွန်ရက်ပေါ်မှ ထွက်သွားပြီး သင့် IP ကို သင့် ecash နှင့် ချိတ်ဆက်စေမည်။ မက်ရှ်ပေါ်တွင် ပို့ခြင်းနှင့် လက်ခံခြင်းမှာ ဆက်လုပ်နိုင်ဆဲဖြစ်သည်။ မည်သို့ပင်ဖြစ်စေ မင့်များသို့ ရောက်ရန် ဆက်တင်များတွင် {setting} ကို ဖွင့်ပါ။",
  ...
  "wallet.send.body":
    "သင့်တွင်ရှိပြီးသား ecash မှ အော့ဖ်လိုင်းတွင် တည်ဆောက်ထားသည်။ တိုကင်ရောက်ကြောင်း အတည်မပြုမချင်း သင့်လက်ကျန်မှ အပြီးအပိုင် ထွက်သွားမည့်အရာ မရှိပါ။",
  ...
  "wallet.send.bearer_note":
    "ဤစာကြောင်းကို ကိုင်ထားသူတိုင်း ငွေပိုင်ရှင်ဖြစ်သည်။ အကြွေစေ့များကို သီးသန့်ထားသည်၊ သုံးလိုက်သည် မဟုတ်ပါ၊ မည်သူ့ထံမျှ မရောက်ခဲ့လျှင် လှုပ်ရှားမှုအောက်တွင် ပြန်ယူနိုင်သည်။",
  ...
  "wallet.send.inexact_body":
    "သင့်အကြွေစေ့များသည် အော့ဖ်လိုင်းတွင် {amount} {unit} အတိအကျ မဖြစ်နိုင်ပါ။ တည်ဆောက်နိုင်သည့် အသေးဆုံးတိုကင်မှာ {spend} {unit} ဖြစ်ပြီး အော့ဖ်လိုင်းတွင် အကြွေပြန်အမ်းခြင်း မရှိပါ၊ ပိုသော {extra} {unit} သည် လက်ခံသူထံ ရောက်သွားမည်။\n\nအွန်လိုင်းဖြစ်စဉ် မင့်တွင် ပြန်လည်စစ်ဆေးခြင်းက သင့်အကြွေစေ့များကို ဤပမာဏအတိအကျ ဖြစ်စေမည့် အစိတ်အပိုင်းများအဖြစ် ခွဲပေးပါမည်။",
  "wallet.send.send_amount": "{amount} ပို့ပါ",
  "wallet.send.sent_to": "{amount} {unit} ကို {name} ထံ ပို့ပြီးပါပြီ",
  "wallet.send.sent_to_body":
    "{route} ၎င်းတို့ရရှိကြောင်း သင်အတည်မပြုမချင်း၊ သို့မဟုတ် တိုကင်ကို ရွေးနုတ်ပြီးကြောင်း မင့်က မပြောမချင်း လှုပ်ရှားမှုအောက်တွင် ပြန်ယူနိုင်ဆဲ ဖြစ်ပါမည်။",
  ...
  "wallet.receive.already_have_body":
    "ဤတိုကင်ရှိ အရာအားလုံးကို ဤနေရာတွင် သိမ်းထားပြီးဖြစ်၍ ဘာမျှ ထပ်မထည့်ပါ။ လက်ကျန်များ မပြောင်းလဲပါ။",
  "wallet.receive.stored_unconfirmed":
    "{mint} မှ သိမ်းထားသော်လည်း မင့်နှင့် အတည်မပြုရသေးပါ ({reason})။",
  "wallet.receive.offline": "အော့ဖ်လိုင်း",
  "wallet.receive.redeemed_here":
    "{mint} တွင် ရွေးနုတ်ပြီးပါပြီ။ ဤ ecash သည် ယခု သင်တစ်ဦးတည်း၏ ဖြစ်သည်၊ ပေးပို့သူ၏ မိတ္တူ အလုပ်မလုပ်တော့ပါ။",
  ...
  "wallet.receive.dleq_missing":
    "၎င်းထဲရှိ အကြွေစေ့အချို့တွင် မင့်၏ လက်မှတ်အထောက်အထား မပါသဖြင့် အော့ဖ်လိုင်းတွင် မစစ်ဆေးနိုင်ခဲ့ပါ။",
  "wallet.receive.dleq_warning":
    "အွန်လိုင်းတွင် အတည်မပြုရမချင်း ပေးပို့သူသည် ၎င်းကို အခြားနေရာတွင် သုံးပြီးဖြစ်နိုင်သည်။",
  "wallet.receive.failed": "လက်မခံနိုင်ပါ",
  "wallet.receive.title": "ecash လက်ခံပါ",
  "wallet.receive.body":
    "Cashu တိုကင်တစ်ခု ကူးထည့်ပါ။ အွန်လိုင်းဖြစ်လျှင် မင့်တွင် ချက်ချင်း ရွေးနုတ်ပါသည်။ အော့ဖ်လိုင်းဖြစ်လျှင် သိမ်းထားပြီး အွန်လိုင်းပြန်ရောက်သည်နှင့် မင့်နှင့် အလိုအလျောက် အတည်ပြုပါသည်။",
  ...
  "wallet.ln.withdrawn":
    "{amount} {unit} ကို Lightning မှတစ်ဆင့် ပေးချေပြီးပါပြီ။ မင့်က လမ်းကြောင်းအခကြေးငွေ {fee} {unit} ကောက်ခံခဲ့သည်။",
  "wallet.ln.withdrawn_with_change":
    "{amount} {unit} ကို Lightning မှတစ်ဆင့် ပေးချေပြီးပါပြီ။ မင့်က လမ်းကြောင်းအခကြေးငွေ {fee} {unit} ကောက်ခံပြီး သီးသန့်ထားငွေမှ {change} {unit} ကို သင့်လက်ကျန်သို့ ပြန်ပေးခဲ့သည်။",
  ...
  "wallet.reclaim.body":
    "{amount} {unit} သည် သင့်လက်ကျန်သို့ ပြန်ရောက်လာမည်ဖြစ်ပြီး မင့်ကို ဆက်သွယ်နိုင်သည်နှင့် သင်ပေးလိုက်သော တိုကင်သည် အလုပ်မလုပ်တော့ပါ။ ထိုမတိုင်မီ ၎င်းတို့ ရွေးနုတ်လိုက်ပါက ငွေသည် ၎င်းတို့ထံတွင်သာ ရှိနေမည်။",
  "wallet.reclaim.keep": "စောင့်ဆိုင်းဆဲ ထားပါ",
  "wallet.reclaim.confirm": "ပြန်ယူပါ",
  "wallet.reclaim.claimed_title": "၎င်းတို့ ရွေးနုတ်ပြီးပါပြီ",
  ...
  "wallet.refresh.swapped":
    "{amount} {unit} ကို အတည်ပြုပြီး ecash အသစ်နှင့် လဲလှယ်ပြီးပါပြီ။",
  "wallet.refresh.secured":
    "ယခု {amount} {unit} ကို သင့်ပြန်လည်ရယူရေးစကားစုက လွှမ်းခြုံထားပါပြီ။",
  "wallet.refresh.refused":
    "{amount} {unit} ကို မင့်က ငြင်းပယ်သဖြင့် သင့်လက်ကျန်မှ ဖယ်ရှားလိုက်ပါပြီ။ တိုကင်ကို လှုပ်ရှားမှုတွင် ဆက်ထားသည်။",
  "wallet.refresh.still_unconfirmed":
    "{amount} {unit} သည် မင့်ကို စောင့်နေဆဲဖြစ်ပြီး နောက်မှ အတည်ပြုပါမည်။",
  "wallet.refresh.all_confirmed":
    "ဤနေရာရှိ အားလုံးကို မင့်နှင့် အတည်ပြုပြီးဖြစ်ပါသည်။",
  "wallet.pending.reserved_desc":
    "တည်ဆောက်ပြီး သီးသန့်ထားသည်၊ ရောက်ရှိမှုကို အတည်မပြုရသေး။ နှစ်ကြိမ်မသုံးမိစေရန် အကြွေစေ့များကို သင့်လက်ကျန်မှ ခွဲထုတ်ထားသည်။",
  ...
  "wallet.mesh_offline_body":
    "မက်ရှ်ဝန်ဆောင်မှု အလုပ်မလုပ်နေသဖြင့် တိုကင်ကို ပေးအပ်စရာ မရှိပါ။ လှုပ်ရှားမှုအောက်တွင် သီးသန့်ထားဆဲ ဖြစ်ပါမည်။",
  ...
  "wallet.xfer.inexact_body":
    "သင့်အကြွေစေ့များသည် အော့ဖ်လိုင်းတွင် {amount} {unit} အတိအကျ မဖြစ်နိုင်ပါ။ တည်ဆောက်နိုင်သည့် အသေးဆုံးတိုကင်မှာ {spend} {unit} ဖြစ်ပြီး ပိုသော {extra} {unit} သည် ပြန်ယူ၍မရဘဲ ၎င်းတို့ထံ ရောက်သွားမည်။\n\nအွန်လိုင်းဖြစ်စဉ် မင့်တွင် ပြန်လည်စစ်ဆေးခြင်းက သင့်အကြွေစေ့များကို ဤပမာဏအတိအကျ ဖြစ်စေမည့် အစိတ်အပိုင်းများအဖြစ် ခွဲပေးပါသည်။",
  ...
  "wallet.pay.rail_nutzap_undelivered":
    "၎င်းတို့၏သော့ဖြင့် သော့ခတ်ထားသော်လည်း သယ်ဆောင်နိုင်သည့်အရာ မရှိသေးပါ။ တန်းစီထားပြီး တိုကင်မှာ လှုပ်ရှားမှုအောက်တွင် ရှိသည်။",
  "wallet.pay.final":
  ...
  "wallet.pay.confirm_reclaimable":
    "သူတို့ မရယူမချင်း လှုပ်ရှားမှုမှ ပြန်ယူနိုင်သည်။",
  ...
  "wallet.explain.intro":
    "Cashu သည် Bitcoin အတွက် ecash ဖြစ်သည်။ တိုကင်ဆိုသည်မှာ ကိုင်ထားသူအတွက် ငွေတန်ဖိုးရှိသော စာကြောင်းတစ်ခုဖြစ်ပြီး မည်သူက ဘာသုံးသည်ကို မင့်မသိစေရန် မျက်စိပိတ်လက်မှတ်ထိုးထားသည်။ အကောင့်လည်း မလို၊ လော့ဂ်အင်လည်း မလိုပါ။ Airhop သည် သင့်ငွေကို ဘယ်တော့မှ မထိန်းထားပါ။ သင့်အကြွေစေ့များသည် ဤဖုန်းပေါ်တွင်ရှိပြီး သင်ရွေးသော မင့်များက ထုတ်ပေးသည်။",
  "wallet.explain.send": "ပို့ပါ",
  "wallet.explain.send_desc":
    "ပမာဏတစ်ခုကို ဘလူးတုသ်မှတစ်ဆင့် အနီးအနားရှိလုပ်ဖော်ကိုင်ဖက်ထံ ပေးအပ်နိုင်သော သို့မဟုတ် စာသားအဖြစ် မျှဝေနိုင်သော တိုကင်အဖြစ် ပြောင်းပေးသည်။ အင်တာနက်မလိုဘဲ အလုပ်လုပ်သည်။ ရောက်ကြောင်း အတည်မပြုမချင်း အကြွေစေ့များကို သီးသန့်ထားပါသည်။",
  ...
  "wallet.svc.tor_ios_body":
    "iOS ပေါ်ရှိ Tor သည် Nostr ကိုသာ လွှမ်းခြုံသဖြင့် ဤတောင်းဆိုမှုသည် ပွင့်လင်းကွန်ရက်မှတစ်ဆင့် မင့်ထံရောက်ပြီး သင့် IP ကို ဤ ecash နှင့် ချိတ်ဆက်စေမည်။ ဆက်တင်များတွင် {setting} ကို ဖွင့်ပါ၊ သို့မဟုတ် Tor ကို အရင်ပိတ်ပါ။ မက်ရှ်ပေါ်တွင် ecash ပို့ခြင်းနှင့် လက်ခံခြင်းမှာ ဆက်လုပ်နိုင်ဆဲဖြစ်သည်။",
  ...
  "wallet.svc.phrase_unreadable":
    "ဤဖုန်းပေါ်တွင် သင့်ပြန်လည်ရယူရေးစကားစုကို ဖတ်၍ မရခဲ့ပါ။",
  "wallet.svc.phrase_unreadable_body":
    "ဘာမျှ မပြောင်းလဲခဲ့ဘဲ စကားစုအသစ်လည်း မပြုလုပ်ခဲ့ပါ။ ဖုန်းကို သော့ဖွင့်ပြီးမှ ထပ်စမ်းကြည့်ပါ။ ထိုအတောအတွင်း သင့် ecash ဆက်အလုပ်လုပ်သည်။",
  ...
  "wallet.svc.refuse_http_body":
    "ကွန်ရက်လမ်းကြောင်းပေါ်ရှိ မည်သူမဆို သင့် ecash ကို ဖတ်နိုင် ပြောင်းလဲနိုင်သည်။ https:// မင့်တစ်ခုကို သုံးပါ။",
  ...
  "wallet.svc.wrong_mint_body":
    "အနည်းဆုံး အကြွေစေ့တစ်ခု၏ လက်မှတ်သည် မင့်၏သော့များနှင့် မကိုက်ညီပါ။ ဘာမျှ မထည့်ခဲ့ပါ။",
  "wallet.svc.unit_mismatch":
    "ဤတိုကင်၏ အကြွေစေ့များသည် ၎င်းဖော်ပြထားသော ငွေကြေးဖြင့် မဟုတ်ပါ။",
  "wallet.svc.unit_mismatch_body":
    "၎င်းကို {label} ဟု ဖော်ပြထားသော်လည်း အကြွေစေ့အချို့ကို {actual} ဖြင့် ထုတ်ပေးခဲ့သည်။ ပေးပို့သူထံ တိုကင်အသစ် တောင်းပါ။ ဘာမျှ မထည့်ခဲ့ပါ။",
  "wallet.svc.locked_other":
    "ဤအကြွေစေ့များကို အခြားသူ၏ ပိုက်ဆံအိတ်ဖြင့် သော့ခတ်ထားသည်။",
  "wallet.svc.locked_other_body":
    "သော့ခတ်ပေးထားသူသာ ၎င်းတို့ကို ရယူနိုင်သည်။ ဘာမျှ မထည့်ခဲ့ပါ။",
  "wallet.svc.coins_refused":
    "မင့်က ဤအကြွေစေ့များကို ငြင်းပယ်သဖြင့် ၎င်းတို့ကို ထည့်မတွက်တော့ပါ။ ပြန်ပို့လိုပါက တိုကင်ကို ဤနေရာတွင် သိမ်းထားသည်။",
  "wallet.svc.coins_unredeemable":
    "ဤအကြွေစေ့များကို ဤမင့်တွင် ရွေးနုတ်၍ မရသဖြင့် ၎င်းတို့ကို ထည့်မတွက်တော့ပါ။ ပြန်ပို့လိုပါက တိုကင်ကို ဤနေရာတွင် သိမ်းထားသည်။",
  "wallet.svc.locked_ours_offline":
    "ဤငွေပေးချေမှုကို သင့်ပိုက်ဆံအိတ်ဖြင့် သော့ခတ်ထားသည်။",
  "wallet.svc.locked_ours_offline_body":
    "အွန်လိုင်းဖြစ်မှ ရယူပါ။ ထိုအတောအတွင်း အခြားမည်သူမျှ ယူ၍ မရပါ။",
  "wallet.svc.already_spent": "ဤ ecash ကို သုံးပြီးဖြစ်သည်။",
  ...
  "wallet.svc.inexact_title":
    "သင့်အကြွေစေ့များသည် အော့ဖ်လိုင်းတွင် {amount} {unit} အတိအကျ မဖြစ်နိုင်ပါ။",
  ...
  "settings.conn.autostart_off_body":
    "Airhop သည် သင့်ဖုန်း ပြန်လည်စတင်ပြီးနောက် ကိုယ်တိုင်ဖွင့်သည်အထိ ပိတ်လျက် ရှိနေပါမည်။",
  ...
  "settings.tor.recovered":
    "ယခင်တစ်ကြိမ်က Tor စတင်ခြင်း မပြီးဆုံးခဲ့သဖြင့် အင်တာနက်အသွားအလာကို ရပ်ထားသည်။ ထပ်စမ်းကြည့်ပါ၊ သို့မဟုတ် Tor မပါဘဲ အွန်လိုင်းတက်ရန် Tor ကို ပိတ်ပါ။",
  "settings.tor.retry": "ထပ်စမ်းကြည့်ပါ",
  ...
  "settings.storage.storage_usage_desc":
    "မက်ဆေ့ဂျ်များ၊ ecash နှင့် သိမ်းထားသော ပူးတွဲဖိုင်များ",
  ...
  "settings.transfer.verify_body":
    "သင့်ဖုန်းအသစ်တွင်လည်း ဤစကားလုံးများအတိုင်း ပြနေရမည်။ ဤနေရာရှိ အားလုံးကို ၎င်းသို့ ရွှေ့ပြီးနောက် ဤဖုန်းကို ဖျက်ပါမည်။",
  "settings.transfer.confirm_cta": "လွှဲပြောင်းပါ",
  "settings.transfer.waiting_confirm": "သင့်ဖုန်းအသစ်တွင် အတည်ပြုပါ",
  ...
  "settings.wipe.desc":
    "သော့၊ မက်ဆေ့ဂျ်နှင့် ecash အားလုံးကို ချက်ချင်း ဖျက်ဆီးပါ",
  "settings.wipe.body":
    "ဤသည်က သင့်သော့၊ မက်ဆေ့ဂျ်နှင့် ecash အားလုံးကို ချက်ချင်း ဖျက်ဆီးပါလိမ့်မည်။ ဤအရာကို ပြန်ပြင်၍ မရပါ။ သင့်ပြခန်းတွင် သိမ်းထားသော ဓာတ်ပုံများမှာ ထိုနေရာတွင် ဆက်ရှိနေမည်။",
  ...
  "settings.version.internet_off":
    "အင်တာနက် ပိတ်ထားစဉ် အပ်ဒိတ်များကို ရပ်ထားသည်။ ဆက်တင်များတွင် {setting} ကို ဖွင့်ပါ။",
...
export const plurals: Plurals = {
  ...
  "wallet.backup.recovered": {
    other: "{mints} မှ မသုံးရသေးသော အကြွေစေ့ {count} ခု ပြန်ရရှိခဲ့သည်။",
  },
  ...
  "wallet.send.stale_fee_note": {
    other:
      "အခကြေးငွေများကို နောက်ဆုံးစစ်ဆေးခဲ့သည်မှာ လွန်ခဲ့သော {count} ရက်က ဖြစ်သည်။ ဤမင့်က ထိုအချိန်မှစ၍ အခကြေးငွေတိုးထားပါက ပို့ခြင်းသည် အနည်းငယ် ပိုကုန်ကျနိုင်သည်။",
  },
