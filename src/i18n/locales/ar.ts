...
export const strings: Strings = {
  ...
  "wallet.balance.tor_blocked":
    "Tor مفعّل، لذا طلبات دار السك محظورة: فهي ستخرج عبر الشبكة المكشوفة وتربط عنوان IP الخاص بك بنقدك الإلكتروني. الإرسال والاستقبال عبر الشبكة ما زالا يعملان. اسمح بحركة دار السك من الإعدادات، الأمان.",
  ...
  "wallet.send.bearer_note":
    "من يحمل هذه السلسلة يملك المال. العملات محجوزة لا منفقة: إن لم تصل أحدًا يمكنك استرجاعها من قسم المعلّقة.",
  ...
  "wallet.send.sent_to_body":
    "{route} ويبقى قابلًا للاسترجاع من قسم المعلّقة حتى تؤكد استلامهم له، أو حتى تخبرنا دار السك أن التوكن صُرف.",
  ...
  "wallet.svc.tor_ios_body":
    "لا يغلّف Arti سوى مقابس Nostr، فسيصل هذا الطلب إلى دار السك عبر الشبكة المكشوفة ويربط عنوان IP الخاص بك بهذا النقد الإلكتروني. اسمح به من الإعدادات > الأمان، أو عطّل Tor أولًا. إرسال النقد الإلكتروني واستقباله عبر الشبكة ما زالا يعملان.",
  ...
  "wallet.svc.lock_in_doubt_body":
    "لم يُرسل أي شيء آخر. العملات محجوزة حتى تؤكد دار السك النتيجة. إن تمّ الدفع، يظهر الرمز المقفل في «قيد الانتظار» لتسلّمه. وإن لم يتم، تعود العملات.",
